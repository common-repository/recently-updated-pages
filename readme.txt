...
Contributors: ehsan4php
Author URI: http://ehsanhaque.com/
...
V 2.0.0 widget code updated to make it combatible with Wordpress v. 6.6.2
...
= 2.0.0 = 
* Latest version compatibility: Updated the code to make this plugin compatible with Wordpress v. 6.6.2